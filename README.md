...
Il marchio **"PATINA"** risulta registrato in Italia (UIBM, reg. 362015000027630, depositato 25/06/2015, rinnovato) nelle classi merceologiche **1** (prodotti chimici), **2** (vernici/pigmenti/coloranti) e **22** (fibre/corde/tele) — tutte relative a prodotti fisici industriali.

Le classi **9** (software, applicazioni mobili) e **42** (servizi informatici, SaaS) risultano **libere** per il nome "Patina".

> **Azione consigliata prima del lancio su Google Play:** registrare il marchio "Patina" in classe 9 + 42 presso UIBM (uibm.gov.it) o tramite EUIPO per copertura europea. Costo stimato: 150–300 € per via nazionale, 850–1.000 € per via comunitaria.
